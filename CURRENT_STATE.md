...
**Unchanged by AURA-301 / AURA-302 / AURA-303.** None of these tasks made a branch-protection change; the required-check set above is unchanged. The Lighthouse advisory job (`lighthouse-advisory`) remains intentionally **non-blocking and NOT a required check**.
