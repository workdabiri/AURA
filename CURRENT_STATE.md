...
**Unchanged by AURA-206.** The AURA-206 Lighthouse advisory job (`lighthouse-advisory`) is intentionally **non-blocking and NOT a required check** — the required-check set above is unchanged.
