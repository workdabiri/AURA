...
/**
 * Areas error boundary — AURA-204 (D-44 error + retry). Client component so it can call
 * `reset()` to re-render the server component. Translations come from the
 * NextIntlClientProvider in the `[locale]` layout. No data details are surfaced to the user.
 */
export default function AreasError({ reset }: { error: Error; reset: () => void }) {
